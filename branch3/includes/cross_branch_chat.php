            ...
            <div class="p-5 border-b border-gray-200 bg-white flex-shrink-0">
                <div class="flex justify-between items-center">
                    <h2 class="text-2xl font-bold text-indigo-700 flex items-center gap-2">
                        <span>Chats</span>
                        <span id="chat-badge-sidebar" class="hidden inline-flex items-center justify-center bg-red-600 text-white text-xs font-semibold rounded-full w-6 h-6">0</span>
                    </h2>
    ...
    <div class="bg-white rounded-lg shadow-2xl w-[90vw] h-[90vh] max-w-6xl flex flex-col overflow-hidden">
        <div id="chat-zoom-content" class="flex-1 overflow-hidden min-h-0">
            <div class="absolute top-4 right-6 z-50">
                <span id="chat-badge-zoom" class="hidden inline-flex items-center justify-center bg-red-600 text-white text-xs font-semibold rounded-full w-6 h-6">0</span>
            </div>
