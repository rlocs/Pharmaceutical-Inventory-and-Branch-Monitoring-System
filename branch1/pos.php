...
<body class="overflow-x-hidden">
    ...
    <div class="app-container bg-white">
        ...
        <nav class="bg-white border-b border-gray-200 flex justify-between items-center px-6 py-3 shadow-sm relative z-20">
        ...
        <main class="bg-custom-bg-white p-6 flex-grow h-full relative z-10">
            ...
            <div class="bg-white p-6 rounded-3xl shadow-lg border border-gray-100">
                <p class="text-center text-gray-500">POS interface coming soon...</p>
            </div>
